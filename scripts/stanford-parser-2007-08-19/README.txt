Stanford Lexicalized Parser v1.6 - 19 Aug 2007.
-------------------------------------------------

Copyright (c) 2002-2007 The Board of Trustees of 
...
For more information about the parser, point a web browser at the
...
using lexparser.bat.  Under Mac OS X, if you have iTerm installed, then
you can also double-click on lexparser-gui.csh and it will work.)


DOING OTHER THINGS

The parser is supplied with several grammars. There are English grammars
both based on the standard LDC Penn Treebank WSJ secs 2-21 (wsj*), and
ones based on an augmented data set, better for questions, commands, and
text from different genres (english*).  There are Chinese grammars
