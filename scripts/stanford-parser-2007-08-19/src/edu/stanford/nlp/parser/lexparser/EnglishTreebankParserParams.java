...
public class EnglishTreebankParserParams extends AbstractTreebankParserParams {
  ...
  public static class EnglishTrain {
     ...
     * but neutral to negative in Factored, and impossible if use gPA.
     * A value of 2 adds in "s" = "'s"
     * and delves further to disambiguate "'s" as BE or HAVE.  Theoretically
     * good, but no practical gains.
     * A value of 3 adds DO and HELP (which also takes VB form complement).
     */
    ...
    if (t.isPreTerminal()) {
      ...
      if (EnglishTrain.splitAux > 1 && (baseCat.equals("VBZ") || baseCat.equals("VBP") || baseCat.equals("VBD") || baseCat.equals("VBN") || baseCat.equals("VBG") || baseCat.equals("VB"))) {
        if (word.equalsIgnoreCase("'s")) {
          ...
          if (word.equalsIgnoreCase("is") || word.equalsIgnoreCase("am") || word.equalsIgnoreCase("are") || word.equalsIgnoreCase("was") || word.equalsIgnoreCase("were") || word.equalsIgnoreCase("'m") || word.equalsIgnoreCase("'re") || word.equalsIgnoreCase("s") || // a few times the apostrophe is missing!
            ...
            cat = cat + "-HV";
                     ...
                     (word.equalsIgnoreCase("do") || word.equalsIgnoreCase("did") || word.equalsIgnoreCase("does") || word.equalsIgnoreCase("done") ||
