...
public class ConstituentEvalByCat extends AbstractEval {
  ...
  public ConstituentEvalByCat(String str, TreebankLanguagePack tlp) {
    super(str);
  ...
  Counter<Label> precisions = new Counter<Label>();
  Counter<Label> recalls = new Counter<Label>();
  Counter<Label> f1s = new Counter<Label>();

  Counter<Label> precisions2 = new Counter<Label>();
  Counter<Label> recalls2 = new Counter<Label>();
  Counter<Label> pnums2 = new Counter<Label>();
  Counter<Label> rnums2 = new Counter<Label>();
