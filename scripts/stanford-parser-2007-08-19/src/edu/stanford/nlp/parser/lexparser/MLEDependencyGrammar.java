...
public class MLEDependencyGrammar extends AbstractDependencyGrammar {
  ...
  protected Counter<IntDependency> stopCounter;  // reduced tag space
  ...
  public MLEDependencyGrammar(TagProjection tagProjection, TreebankLangParserParams tlpParams, boolean directional, boolean useDistance, boolean useCoarseDistance) {
    ...
    argCounter = new Counter<IntDependency>();
    stopCounter = new Counter<IntDependency>();
...
//    System.err.println("stop size: " + stopCounter.size() + "  total: " + stopCounter.totalCount());
    ...
    Counter<IntDependency> compressedArgC = argCounter;
    argCounter = new Counter<IntDependency>();
    Counter<IntDependency> compressedStopC = stopCounter;
    stopCounter = new Counter<IntDependency>();
...
//    System.err.println("stop size: " + stopCounter.size() + "  total: " + stopCounter.totalCount());
    ...
    Counter<IntDependency> fullArgCounter = argCounter;
    argCounter = new Counter<IntDependency>();
    ...
    Counter<IntDependency> fullStopCounter = stopCounter;
    stopCounter = new Counter<IntDependency>();
