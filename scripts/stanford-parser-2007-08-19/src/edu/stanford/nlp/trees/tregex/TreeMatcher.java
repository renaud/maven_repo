 ...
 * <i>This class is still used by quite a bit of existing code, but new 
...
public class TreeMatcher {
  ...
  TreePatternIterator i; /* iterator over TreePattern nodes */
  TreePattern currentPatternNode; /* most recent node from i */

  List stack; /* stack of iterators over Tree nodes */
  Iterator currentTreeIterator; /* not on the stack */
  ...
  public boolean find() {
    ...
    while (true) {
      ...
      t = (Tree) currentTreeIterator.next();
      //       if(t==null) {
