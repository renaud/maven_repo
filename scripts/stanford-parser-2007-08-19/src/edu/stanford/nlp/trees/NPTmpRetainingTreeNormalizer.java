...
public class NPTmpRetainingTreeNormalizer extends BobChrisTreeNormalizer {
  ...
  public Tree normalizeWholeTree(Tree tree, TreeFactory tf) {
    ...
    Filter subtreeFilter = new Filter() {
      public boolean accept(Object obj) {
        Tree t = (Tree) obj;
        Tree[] kids = t.children();
        Label l = t.label();
        // The special Switchboard non-terminals clause. Nte that it deletes IP which other Treebanks might use
    ...
    Filter nodeFilter = new Filter<Tree>() {
